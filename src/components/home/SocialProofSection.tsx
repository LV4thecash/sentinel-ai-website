...
export function SocialProofSection() {
  ...
  const cardStyle = (id: string, dimmed = false): React.CSSProperties => ({
    ...
    border: `1px solid ${hoveredCard === id ? "var(--glass-border-hi)" : "var(--glass-border)"}`,
    ...
    boxShadow:
      hoveredCard === id
        ...
        : "var(--shadow-glass)",
    opacity: dimmed && hoveredCard !== id ? 0.65 : 1,
    transform:
          ...
          <FadeIn>
            ...
            >
              ...
              >
                ...
                traders. We&apos;re expanding access carefully. Precision over
                growth.
              </p>
            </div>
          </FadeIn>
